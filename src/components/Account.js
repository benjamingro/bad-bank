...
function Account({validateLogin,userAccount,handleLogout,handleNewAccount,startNewAccount,setStartNewAccount,startNewAccountSuccess,setStartNewAccountSuccess}){
        ...
        <>
            ...
            <div className="row w-100">
                ...
                <div className="col-lg-6">
                    ...
                    {startNewAccountSuccess && <StartNewAccountSuccess userAccount={userAccount} setStartNewAccountSuccess={setStartNewAccountSuccess} /> }
                </div>
                <div className="col-lg-3"></div>
